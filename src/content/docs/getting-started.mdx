...
To create your own documentation site using GootaDocs, follow these steps:
- Visit the [GootaDocs GitHub](https://github.com/goota/GootaDocs) repository.
- Click on the "Use this template" button.
- Follow the prompts to create a new repository using this template.

<Callout variant="info">
Try GootaDocs in your browser: [open the template on StackBlitz](https://stackblitz.com/github/goota/GootaDocs)
</Callout>
...
GootaDocs is built to be highly customizable. You can start editing the markdown files in the content folder to create your own documentation pages.
