...
GootaDocs creates your site's HTML pages from your content, offering flexible options through Markdown frontmatter. Additionally, GootaDocs projects have complete access to [Astro's robust page generation tools](https://docs.astro.build/en/basics/astro-pages/). This guide explains how page generation works in GootaDocs.

## Content pages

### File formats

GootaDocs supports authoring content in Markdown and MDX with no configuration required. 
...
All GootaDocs pages share a customizable set of frontmatter properties that control their appearance:
